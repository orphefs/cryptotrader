...
def _download_test_data_from_cobinhood():
    ...
    candles = _download_historical_data_from_cobinhood(time_window, trading_pair,sampling_period, client)[0:100]
    print(candles)
...
def _download_test_data_from_binance():
    ...
    candles = _download_historical_data_from_binance(time_window, trading_pair, sampling_period, client)[0:50]
    print(candles)
    stock_data = StockData(candles, trading_pair)
...
if __name__ == '__main__':
    _download_test_data_from_cobinhood()
